...
public class FileUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File[] srcfile = {f1, f2};
        //压缩后的文件
        File zipfile = new File("F:\\img\\temp\\createAppLangFile.zip");
        //TestZIP.zipFiles(srcfile, zipfile);
        //需要解压缩的文件
        File file = new File("F:\\img\\temp\\createAppLangFile.zip");
        //解压后的目标目录
        ...
        //检出svn代码
        String targetPath = "/usr/local/createAppLangFile";
        String svnUrl ="http://172.24.20.199/svn/svnrepos/Cloud/Java/branch/createAppLangFile/cloud/core";
        String command="cd "+targetPath+" && svn checkout "+svnUrl;
        //Runtime.getRuntime().exec(command);
    }


    public static void resizeProportion(String fromFile, String toFile, int outputWidth, int outputHeight) {
        try {
