...
public class exportTest extends BaseTest {
    ...
    @Test
    public void export(){
        List<Object> agencyList = new ArrayList<>();
        Map<String, Object> agencyMap = new HashMap<>();
        agencyMap.put("agencyName", "agencyName");
        agencyMap.put("agencyAddress", "agencyAddress");
        agencyMap.put("companyName", "lds");
        agencyMap.put("logoImageId", "Leedarson");
        agencyMap.put("auctionAddress", "虾米");
        agencyMap.put("logoImage", new Date());
        ...
        JSONArray jsonObject = JSONArray.fromObject(agencyList,jsonConfig);
        String jsonString1 = jsonObject.toString();
        createJsonFile(jsonString1, "C:\\Users\\chenhongqiao\\Desktop\\export12", "agency2");
