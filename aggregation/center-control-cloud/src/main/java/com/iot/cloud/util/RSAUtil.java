...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {
        Map<String, Key> keys = RSAUtil.initKey();
        String publicKey=new String(getPublicKeyByte(keys));
        String privateKey=new String(getPrivateKeyByte(keys));
        String value = "123456";
        System.out.println(value);
        byte[] key1 = RSAUtil.encryptByPublicKey(value.getBytes(), getPublicKeyByte(keys));
        System.out.println(new String(key1));
        byte[] key2 =RSAUtil.decryptByPrivateKey(key1,getPrivateKeyByte(keys));
