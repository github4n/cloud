...
-- 导出 iot_db_schedule 的数据库结构
CREATE DATABASE IF NOT EXISTS `iot_db_schedule` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `iot_db_schedule`;


-- 导出  表 iot_db_schedule.qrtz_blob_triggers 结构
...
-- 导出  表 iot_db_schedule.qrtz_calendars 结构
...
-- 导出  表 iot_db_schedule.qrtz_cron_triggers 结构
...
-- 导出  表 iot_db_schedule.qrtz_fired_triggers 结构
...
-- 导出  表 iot_db_schedule.qrtz_job_details 结构
...
-- 导出  表 iot_db_schedule.qrtz_locks 结构
...
-- 导出  表 iot_db_schedule.qrtz_paused_trigger_grps 结构
...
-- 导出  表 iot_db_schedule.qrtz_scheduler_state 结构
...
-- 导出  表 iot_db_schedule.qrtz_simple_triggers 结构
...
-- 导出  表 iot_db_schedule.qrtz_simprop_triggers 结构
...
-- 导出  表 iot_db_schedule.qrtz_triggers 结构
