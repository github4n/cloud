 ...
 */
@Service
public class MonthlyRuntimeServiceImpl extends ServiceImpl<MonthlyRuntimeMapper, MonthlyRuntime> implements IMonthlyRuntimeService {
	...
	public List<MonthlyRuntime> selectByCondition(MonthlyRuntime monthlyRuntime) {
		...
		return monthlyRuntimeMapper.selectMonthlyRuntimeByCondition(monthlyRuntime);
	}
...
//	}
	...
	public Page<EnergyRsp> selectMonthlyRuntimeRsp(RuntimeReq2Runtime runtimeReq) {
		...
		ew.setSqlSelect(" CONCAT(year,'-',month) as time, runtime as value");
		...
		List<Map<String, Object>> returnDataList = monthlyRuntimeMapper.selectMapsPage(page, ew);
