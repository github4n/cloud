...
public class ModuleEventToPropertyReq implements Serializable {
    ...
    public List getEventPropertyIds() {
        return eventPropertyIds;
    }

    public void setEventPropertyIds(List eventPropertyIds) {
        this.eventPropertyIds = eventPropertyIds;
    }
}
