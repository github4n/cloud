 ...
 * 修改描述：
 */
@ApiModel(description = "文案基础信息（模板）实体类")
public class LangInfoBase {
    ...
    @ApiModelProperty(name = "langType", value = "语言类型(zh_CN;en_US(默认))", dataType = "String")
    ...
    public LangInfoBase(Long tenantId, String objectType, Long objectId, String langType, String langKey, String langValue, Long createBy, Date createTime, String belongModule) {
        this.tenantId = tenantId;
        this.objectType = objectType;
        this.objectId = objectId;
        this.langType = langType;
    ...
    public LangInfoBase(Long tenantId,String objectType, Long objectId, String langType, String langKey, String langValue) {
        this.tenantId = tenantId;
        this.objectType = objectType;
        this.objectId = objectId;
        this.langType = langType;
    ...
    public LangInfoBase(String langKey, String langType,  String langValue) {
        this.langType = langType;
        this.langKey = langKey;
        this.langValue = langValue;
    }
