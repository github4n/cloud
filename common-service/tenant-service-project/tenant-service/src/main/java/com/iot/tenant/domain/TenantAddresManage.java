 ...
 */
@TableName("tenant_addres_manage")
public class TenantAddresManage {

    /***/
	@SuppressWarnings("unused")
	private static final long serialVersionUID = 1082638030426822302L;

	public static final String TABLE_NAME = "tenant_addres_manage";
