...
-- ----------------------------
CREATE TABLE `iot_db_device`.`ota_device_version` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1371 DEFAULT CHARSET=utf8mb4 COMMENT='设备-固件类型-版本表';

-- ----------------------------
-- Table structure for ota_firmware_version
-- ----------------------------
CREATE TABLE `iot_db_device`.`ota_firmware_version` (
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='OTA固件版本表';

-- ----------------------------
-- Table structure for ota_upgrade_log
-- ----------------------------
CREATE TABLE `iot_db_device`.`ota_upgrade_log` (
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='OTA升级日志表';

-- ----------------------------
-- Table structure for ota_upgrade_plan
-- ----------------------------
CREATE TABLE `iot_db_device`.`ota_upgrade_plan` (
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='OTA升级计划表';

-- ----------------------------
-- Table structure for ota_upgrade_plan_detail
-- ----------------------------
CREATE TABLE `iot_db_device`.`ota_upgrade_plan_detail` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '明细id',
  `plan_id` bigint(20) NOT NULL COMMENT '升级计划id',
  `has_transition` tinyint(1) NOT NULL COMMENT '是否有过渡版本 true/false',
  PRIMARY KEY (`id`),
  KEY `plan_id_index` (`plan_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COMMENT='OTA升级计划明细表';

-- ----------------------------
-- Table structure for ota_upgrade_plan_log
-- ----------------------------
CREATE TABLE `iot_db_device`.`ota_upgrade_plan_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '日志id',
  `plan_id` bigint(20) NOT NULL COMMENT '升级计划id',
  `tenant_id` bigint(20) NOT NULL COMMENT '租户id',
  ...
  KEY `plan_id_index` (`plan_id`) USING BTREE,
  KEY `tenant_id_index` (`tenant_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='OTA升级计划操作日志表';

-- ----------------------------
-- Table structure for ota_upgrade_plan_substitute
-- ----------------------------
CREATE TABLE `iot_db_device`.`ota_upgrade_plan_substitute` (
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='OTA升级替代版本表';

-- ----------------------------
-- Table structure for ota_upgrade_plan_transition
-- ----------------------------
CREATE TABLE `iot_db_device`.`ota_upgrade_plan_transition` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `detail_id` bigint(20) NOT NULL COMMENT '明细id',
  `transition_version` varchar(32) NOT NULL COMMENT '过渡版本号',
  PRIMARY KEY (`id`),
  KEY `detail_id_index` (`detail_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COMMENT='OTA升级过渡版本表';
