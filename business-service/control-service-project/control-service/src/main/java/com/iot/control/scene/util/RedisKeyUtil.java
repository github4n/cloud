package com.iot.control.scene.util;
...
public class RedisKeyUtil {
    ...
    public static final String SCENE_DETAIL_COUNT = "scene-d-c:%d:%d";
    ...
    /**
     *  sceneId 对应的 sceneDetail数量 缓存key
     * @param sceneId
     * @return
     */
    public static String getSceneDetailCountKey(Long sceneId, Long tenantId) {
        return String.format(SCENE_DETAIL_COUNT, sceneId, tenantId);
    }
