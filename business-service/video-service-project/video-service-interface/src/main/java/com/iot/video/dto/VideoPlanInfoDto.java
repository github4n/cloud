 ...
 */
public class VideoPlanInfoDto implements Serializable {
	...
	public String toString() {
		return "VideoPlanInfoDto{" +
				...
				", planOrder=" + planOrder +
				", planExecStatus='" + planExecStatus + '\'' +
				", deviceStatus='" + deviceStatus + '\'' +
				", overdueStatus='" + overdueStatus + '\'' +
				", planName='" + planName + '\'' +
				", packageType='" + packageType + '\'' +
				", eventOrFulltimeAmount=" + eventOrFulltimeAmount +
				...
				", renewRemindFlag=" + renewRemindFlag +
				'}';
	}
}
