...
public class UserActivatedDetailDataResp {
    ...
    public UserActivatedDetailDataResp(Long yesUserActivated, Long todUserActivated, Long lastWeekUserActivated, Long beforeLastWeekUserActivated) {
