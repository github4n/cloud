...
public class Constants {
	...
	public final static Integer IS_APP_DEV = 1; //app子设备

	public final static String TOPIC_CLIENT_PREFIX = "iot/v1/c/";
	public final static String TOPIC_SERVER_PREFIX="iot/v1/s/";
