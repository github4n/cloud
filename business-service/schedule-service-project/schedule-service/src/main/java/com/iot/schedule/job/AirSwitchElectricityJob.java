 ...
 * @Description: *
 */
public class AirSwitchElectricityJob implements Job {


    @Override
    public void execute(JobExecutionContext context) throws JobExecutionException {
        System.out.println("========================= air switch electricity job start ======================");
        try {
            ...
            for (Long tenantId : idList) {
                statisticsApi.countElectricity(tenantId);
            }

        } catch (Exception e) {
            e.printStackTrace();
        }
        System.out.println("========================= air switch electricity job end ======================");
    }
}
