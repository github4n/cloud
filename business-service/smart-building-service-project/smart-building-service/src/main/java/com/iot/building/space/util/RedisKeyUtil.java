package com.iot.building.space.util;
...
import com.iot.building.space.enums.MultiCacheKeyEnum;
import com.iot.building.space.enums.VersionEnum;
...
public class RedisKeyUtil {
    ...
    public static String getSpaceDevKey(Long tenantId, Long spaceId) {
        return SPACE_DEVICE_KEY + VERSION + spaceId;
    }
