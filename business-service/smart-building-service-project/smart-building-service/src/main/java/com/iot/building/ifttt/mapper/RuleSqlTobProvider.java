...
public class RuleSqlTobProvider {

    public String insertSelective(Rule record) {
        BEGIN();
        INSERT_INTO("build_tob_rule");
       ...
       /* if (record.getSecurityType() != null) {
        ...
        if (record.getAppletId() != null) {
            VALUES("appletId", "#{appletId,jdbcType=BIGINT}");
        }
        if (record.getShortcut() != null) {
        	VALUES("shortcut", "#{shortcut,jdbcType=INTEGER}");
        }
        if (record.getUploadStatus() != null) {
            VALUES("upload_status", "#{uploadStatus,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Rule record) {
        ...
        if (record.getAppletId() != null) {
            SET("appletId = #{appletId,jdbcType=BIGINT}");
        }
        if (record.getUploadStatus() != null) {
    ...
    public String findSimpleList(RuleListReq req) {
        ...
        if(req.getAppletId() !=null){
            WHERE("appletId = #{appletId,jdbcType=BIGINT}");
        }
    ...
    public String listByIds(@Param("ids") List<String> ids) {
        ...
        SELECT("id, name, icon, type, status, is_multi, location_id, space_id, tenant_id, user_id, " +
                ...
                "template_id, ifttt_type, appletId ");
        FROM("build_tob_rule");
