...
public class MethodMaping {
	...
	private static final String OTA_VERSION_NOTIFY="ota_version_notify";//OTA升级版本上报
	private static final String UPDATE_PROP_RESP="update_prop_resp";//子设备属性实时上报
	private static final String IFTTT_STATE_NOTITY = "state_notify";//IFTTT 联动运行状态上报
	private static final String GET_INFO_RESP="get_info_resp";//获取网关信息回调
	...
	private static final String R_OTA_VERSION_NOTIFY="otaVersionNotify";//OTA升级版本上报
	private static final String R_UPDATE_PROP_RESP="updatePropResp";//子设备属性实时上报
	private static final String R_IFTTT_STATE_NOTIFY="iftttStateNotify";//IFTTT 联动运行状态上报
	private static final String R_GET_INFO_RESP="getInfoResp";//获取网关信息回调
	...
	public static void init() {
		...
		methodMap.put(OTA_VERSION_NOTIFY, R_OTA_VERSION_NOTIFY);
		methodMap.put(UPDATE_PROP_RESP, R_UPDATE_PROP_RESP);
		methodMap.put(IFTTT_STATE_NOTITY, R_IFTTT_STATE_NOTIFY);
		methodMap.put(GET_INFO_RESP, R_GET_INFO_RESP);
	}
