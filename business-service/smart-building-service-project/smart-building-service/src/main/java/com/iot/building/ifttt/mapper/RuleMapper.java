...
public interface RuleMapper {
    ...
    @Select({
            "select",
            "id, name, icon,deployMent_id, type, status, is_multi, location_id, space_id, tenant_id, user_id, ",
            "direct_id, org_id, create_time, update_time, template_flag, product_id, rule_type, security_type, ",
            "delay, template_id, ifttt_type,shortcut ",
            "from ifttt_rule",
    ...
    @Results({
            ...
            @Result(column = "deployMent_id", property = "deployMentId", jdbcType = JdbcType.BIGINT),
            ...
            @Result(column = "shortcut", property = "shortcut", jdbcType = JdbcType.INTEGER),
    })
    ...
    @Results({
            ...
            @Result(column = "name", property = "name", jdbcType = JdbcType.VARCHAR),
            @Result(column = "icon", property = "icon", jdbcType = JdbcType.VARCHAR),
            @Result(column = "deployMent_id", property = "deployMentId", jdbcType = JdbcType.VARCHAR),
            @Result(column = "type", property = "type", jdbcType = JdbcType.VARCHAR),
            @Result(column = "status", property = "status", jdbcType = JdbcType.TINYINT),
            @Result(column = "is_multi", property = "isMulti", jdbcType = JdbcType.TINYINT),
            @Result(column = "location_id", property = "locationId", jdbcType = JdbcType.BIGINT),
