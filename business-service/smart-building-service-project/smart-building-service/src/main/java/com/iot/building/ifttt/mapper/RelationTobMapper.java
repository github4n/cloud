...
public interface RelationTobMapper {
    @Delete({
            "delete from tob_relation",
    ...
    @Insert({
            "insert into tob_relation (id, label, ",
            "type, parent_labels, ",
    ...
    @InsertProvider(type = RelationSqlTobProvider.class, method = "insertSelective")
    ...
    @UpdateProvider(type = RelationSqlTobProvider.class, method = "updateByPrimaryKeySelective")
