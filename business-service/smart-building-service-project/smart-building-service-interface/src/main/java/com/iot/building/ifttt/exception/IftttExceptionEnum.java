package com.iot.building.ifttt.exception;
...
public enum IftttExceptionEnum implements IBusinessException {
	...
	SAVE_IFTTT_TEMPLATE_ERROR(113024, "save.ifttt.template.error"),
	DELETE_IFTTT_TEMPLATE_ERROR(113025, "delete.ifttt.template.error"),
	UPDATE_RULE_STATUS_FAILED(11400, "update.rule.status.failed");
	private int code;

	private String messageKey;

	IftttExceptionEnum(String messageKey) {
		code = 0;
